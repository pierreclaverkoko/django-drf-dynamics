...
class ListConfigurationSerializer(serializers.Serializer):
    ...
    filter_position = serializers.ChoiceField(
        choices=['top', 'sidebar', 'modal'],
        default='top'
    )
    ...
    realtime_events = serializers.ListField(
        child=serializers.ChoiceField(choices=['create', 'update', 'delete']),
...
class SearchMetadataSerializer(serializers.Serializer):
    ...
    search_types = serializers.ListField(
        child=serializers.ChoiceField(
            choices=['exact', 'icontains', 'istartswith', 'iendswith', 'regex']
        ),
        default=['icontains']
    )
